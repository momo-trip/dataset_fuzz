 ...
 */
static char const tcpreplay_opt_strs[6567] =
...
/*  5441 */ "Print version information\0"
/*  5467 */ "VERSION\0"
/*  5475 */ "version\0"
/*  5483 */ "Display less usage information and exit\0"
/*  5523 */ "LESS_HELP\0"
/*  5533 */ "less-help\0"
/*  5543 */ "display extended usage information and exit\0"
/*  5587 */ "help\0"
/*  5592 */ "extended usage information passed thru pager\0"
/*  5637 */ "more-help\0"
/*  5647 */ "save the option state to a config file\0"
/*  5686 */ "save-opts\0"
/*  5696 */ "load options from a config file\0"
/*  5728 */ "LOAD_OPTS\0"
/*  5738 */ "no-load-opts\0"
/*  5751 */ "no\0"
/*  5754 */ "TCPREPLAY\0"
/*  5764 */ "tcpreplay (tcpreplay) - Replay network traffic stored in pcap files\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n"
            "\t\t<pcap_file(s)> | <pcap_dir(s)>\n\0"
/*  5925 */ "$$/\0"
/*  5929 */ ".tcpreplayrc\0"
/*  5942 */ "tcpreplay-users@lists.sourceforge.net\0"
/*  5980 */ "tcpreplay is a tool for replaying network traffic from files saved with\n"
            "tcpdump or other tools which write pcap(3) files.\n\0"
/*  6103 */ "The basic operation of tcpreplay is to resend all packets from the input\n"
...
/**
 *  xdp-batch-size option description:
 */
#ifdef HAVE_LIBXDP
...
#define XDP_BATCH_SIZE_DFT_ARG   ((char const*)25)
...
#define VERSION_DESC      (tcpreplay_opt_strs+5441)
/** Upper-cased name for the version option */
#define VERSION_NAME      (tcpreplay_opt_strs+5467)
/** Name string for the version option */
#define VERSION_name      (tcpreplay_opt_strs+5475)
...
#define LESS_HELP_DESC      (tcpreplay_opt_strs+5483)
/** Upper-cased name for the less-help option */
#define LESS_HELP_NAME      (tcpreplay_opt_strs+5523)
/** Name string for the less-help option */
#define LESS_HELP_name      (tcpreplay_opt_strs+5533)
 ...
 */
#define HELP_DESC       (tcpreplay_opt_strs+5543)
#define HELP_name       (tcpreplay_opt_strs+5587)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (tcpreplay_opt_strs+5592)
#define MORE_HELP_name  (tcpreplay_opt_strs+5637)
...
#endif
#define SAVE_OPTS_DESC  (tcpreplay_opt_strs+5647)
#define SAVE_OPTS_name  (tcpreplay_opt_strs+5686)
#define LOAD_OPTS_DESC     (tcpreplay_opt_strs+5696)
#define LOAD_OPTS_NAME     (tcpreplay_opt_strs+5728)
#define NO_LOAD_OPTS_name  (tcpreplay_opt_strs+5738)
#define LOAD_OPTS_pfx      (tcpreplay_opt_strs+5751)
...
static tOptDesc optDesc[OPTION_CT] = {
  ...
  {  /* entry idx, value */ 75, VALUE_OPT_VERSION,
     /* equiv idx, value */ 75, VALUE_OPT_VERSION,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 76, VALUE_OPT_LESS_HELP,
     /* equiv idx, value */ 76, VALUE_OPT_LESS_HELP,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
...
doOptExclude(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from tcpreplay_opts.def, line 342 */
...
doOptListnics(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from tcpreplay_opts.def, line 373 */
...
doOptVersion(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from tcpreplay_opts.def, line 732 */
...
doOptLess_Help(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from tcpreplay_opts.def, line 804 */
...
tOptions tcpreplayOptions = {
    ...
    81 /* full option count */, 77 /* user option count */,

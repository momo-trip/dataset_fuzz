...
#define HAVE_PCAP_OPEN_OFFLINE_WITH_TSTAMP_PRECISION 1
...
#define PACKAGE_STRING "tcpreplay 4.5.1"
...
#define PCAP_TSTAMP_US_TO_NS_MULTIPLIER 1

/* Divisor for conversion from PCAP usec to usec */
#define PCAP_TSTAMP_US_TO_US_DIVISOR 1000
